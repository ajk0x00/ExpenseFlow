...
5. **Use List Comprehensions**: Prefer list comprehensions for creating lists over traditional loops when appropriate.s
...
11. **Create Tests**: Whenever a new enpoint is created make sure to create its test under tests/apis
